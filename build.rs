...
fn main() {
    ...
    cxx_build::bridges(["src/actor.rs", "src/config.rs", "src/lib.rs"])
        ...
        .include("D:\\vcpkg\\installed\\x64-windows\\include")
        .flags(if lto { vec!["-flto=thin"] } else { vec![] })
        .flag_if_supported("/EHsc") // Add this for MSVC
